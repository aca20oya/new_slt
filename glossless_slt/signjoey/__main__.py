...
from signjoey.prediction import test, translate
...
def main():
    ...
    ap.add_argument("mode", choices=["train", "test", "translate", "train_dgs", "test_dgs", "translate_dgs"], help="train a model or test")
    ...
    ap.add_argument(
        "--openpose", type=str, help="path to openpose data to translate"
    )
    ...
    if args.mode == "train":
        ...
        translate(cfg_file=args.config_path, ckpt=args.ckpt, output_path=args.output_path, openpose_path=args.openpose)
