...
from signjoey.data import load_data, make_data_iter, load_one,load_mono_dgs, load_dgs
...
def validate_on_data(
    ...
    with torch.no_grad():
        ...
        if do_recognition:
            ...
            if dataset_version == "phoenix_2014_trans" or "dgs_corpus":
...
def translate(cfg_file: str, ckpt: str, output_path: str = None, openpose_path: str = None,
    ...
    if dataset_version == "dgs_corpus":
        ...
        translate_data, gls_vocab, txt_vocab = load_one(data_cfg=cfg["data"])
