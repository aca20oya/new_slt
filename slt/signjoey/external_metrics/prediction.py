...
from signjoey.data import load_data, make_data_iter, load_one, load_mono
...
def translate(cfg_file: str, ckpt: str, output_path: str = None,
    ...
    test_data, gls_vocab, txt_vocab = load_one(data_cfg=cfg["data"])
